...
# Exercise-2 TODOs:
    ...
    filename = 'outlier_filtering.pcd'
...
def pr2_mover(object_list):
    ...
    for i in range(0, len(object_list_param)):
        ...
        # Sending the object centroid data as the pick_pose variable
        ...
        place_pose = [0, 0, 0]
        for place_pose_position in place_pose_param:
            if place_pose_position['group'] == object_group:
               place_pose = place_pose_position['position']        
    ...
    out_file = send_to_yaml(output_1.yaml, dict_list)
